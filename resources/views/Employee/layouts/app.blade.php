            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            @foreach($languages as $index=>$language)
                                <a class="dropdown-item" href="{{ route('employee.change.lang',$index) }}" data-language="{{ $index }}">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ auth('employee')->user()->name }}</span><span class="user-status">متاح</span></div><span><img class="round" src="{{ url('uploads/employees/avatar/' . auth('employee')->user()->photo) }}" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route('employee.profile') }}"><i class="feather icon-user"></i> الملف الشخصي</a>
                            <a class="dropdown-item" href="#"><i class="feather icon-mail"></i> الرسائل</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('employee.logout') }}"><i class="feather icon-power"></i> تسجيل الخروج</a>
                        </div>
                    </li>
                </ul>
            </div>
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('assets/Admin') }}/html/rtl/vertical-menu-template/index.html">
                    ...
                    <h2 class="brand-text mb-0">لوحة الموظفين</h2>
                </a></li>
    ...
    <div class="main-menu-content">
        @include('Employee.layouts._sidebar')
    </div>
</div>
<!-- END: Main Menu-->
