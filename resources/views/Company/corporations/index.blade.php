            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">جدول الشركات التابعة</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">الرئيسية</a>
                                    </li>
                                    <li class="breadcrumb-item active">ادارة الشركات التابعة
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">الشركات التابعة</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">
                                        <a href="{{ route('company.corporations.create') }}" class="btn btn-success">اضف جديد</a>
                                            ...
                                            <tbody>
                                                @foreach($elements as $index=>$element)
                                                    <tr>
                                                        <td>{{ $index +1 }}</td>
                                                        <td>{{ $element->title }}</td>
                                                        <td>{{ Str::limit(strip_tags($element->description),20) }}</td>
                                                        <td>
                                                            <form action="{{ route('company.corporations.destroy',$element->id) }}" method="post">
                                                                @method('delete')
                                                                {{ csrf_field() }}
                                                                <a href="{{ route('company.corporations.edit',$element->id) }}" class="btn btn-success"><i class="fa fa-edit"></i> تعديل</a>
    ...
    <script>
        $('.delete_class').on('click',function (e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    window.location.href = `{{ route('company.corporations.destroy') }}/${that.dataset.id}`;
                }
            })
        });
    </script>
