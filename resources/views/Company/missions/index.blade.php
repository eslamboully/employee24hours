            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">جدول المهام</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">الرئيسية</a>
                                    </li>
                                    <li class="breadcrumb-item active">ادارة المهام
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">
                                        <a href="{{ route('company.missions.create') }}" class="btn btn-success">اضف جديد</a>
                                            ...
                                            <tbody>
                                                @foreach($elements as $index=>$element)
                                                    <tr>
                                                        ...
                                                        <td style="{{ $element->status == 2 ? 'text-decoration: line-through;' : '' }}">{{ $element->mission }}</td>
                                                        @if($element->status == 0)
                                                            <td>متأخره</td>
                                                        ...
                                                        @endif
                                                        <td>
                                                            <a href="{{ route('company.missions.edit.status',$element->id) }}" class="btn btn-info">
                                                                <i class="fa fa-edit"></i>
                                                                انجزت
                                                            </a>
                                                            <a class="btn btn-primary" href="{{ route('company.missions.destroy',$element->id) }}">
