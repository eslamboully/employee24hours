            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">تقارير المستحقات والارباح</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">الرئيسية</a>
                                    </li>
                                    <li class="breadcrumb-item active">ادارة المستحقات والارباح
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">تقارير الارباح</h4>
                            </div>
                                            ...
                                            <tbody>
                                                @foreach($elements as $index=>$element)
                                                    <tr>
                                                        ...
                                                        <td>{{ $element->job->convention->agreement->title }}</td>
                                                        <td>
                                                            @if($element->is_received == 1)
