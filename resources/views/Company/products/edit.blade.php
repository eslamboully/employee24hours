            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">تعديل منتجات</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">تعديل بيانات منتج</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form form-horizontal" action="{{ route('company.products.update',$element->id) }}" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            @method('put')
                                            <div class="form-body">
                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <fieldset class="form-group">
                                                                    <label for="basicInputFile">تغيير صورة المنتج</label>
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" name="photo" id="inputGroupFile01">
                                                                        <label class="custom-file-label" for="inputGroupFile01">تغيير الصورة</label>
                                                                    </div>
                                                                </fieldset>
                                                            </div>
                                                            <div class="col-4">
                                                                                ...
                                                                                <div class="controls">
                                                                                    ...
                                                                                    <select name="department_id" id="" class="form-control">
                                                                                        @foreach($departments as $department)
                                                                                            <option value="{{ $department->id }}" {{ $element->department_id == $department->id ? 'selected' : '' }}>{{ $department->title }}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    ...
                                                                                    <input type="text" name="price" class="form-control" placeholder="سعر المنتج" value="{{ $element->price }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    <select name="status" id="" class="form-control">
                                                                                        ...
                                                                                        <option {{ $element->status == 'cold' ? 'selected' : '' }} value="cold">بارد</option>
                                                                                        <option {{ $element->status == 'hot' ? 'selected' : '' }} value="hot">حار</option>
                                                                                        <option {{ $element->status == 'not_food' ? 'selected' : '' }} value="not_food">غير غذائي</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-4">
                                                                <div class="form-group row">
                                                                    <div class="col-md-12">
                                                                        <input type="number" id="first-name" class="form-control" name="quantity" value="{{ $element->quantity }}" placeholder="الكمية">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div class="form-group row">
                                                                    <div class="col-md-12">
                                                                        <input type="number" id="first-name" class="form-control" name="loyalty_points" value="{{ $element->loyalty_points }}" placeholder="نقاط الولاء">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
