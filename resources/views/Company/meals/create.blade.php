            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">اضف وجبة جديدة</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">الرئيسية</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">الوجبة</a>
                                    </li>
                                    <li class="breadcrumb-item active">اضف وجبة
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">وجبة جديدة</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form form-horizontal" action="{{ route('company.meals.store') }}" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    ...
                                                                                    <input type="text" name="start_offer_at" class="form-control pickadate">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    ...
                                                                                    <input type="text" name="end_offer_at" class="form-control pickadate">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    ...
                                                                                    <input type="number" name="price" class="form-control" placeholder="سعر المنتج" value="{{ old('price') }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    ...
                                                                                    <input type="number" name="offer_price" class="form-control" placeholder="سعر العرض" value="{{ old('offer_price') }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
