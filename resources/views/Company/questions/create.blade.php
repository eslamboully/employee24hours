            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">اضف سؤال جديدة</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">اضف سؤال
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">اسئلة جديدة</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form form-horizontal" action="{{ route('company.questions.store') }}" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ str_replace(' ','-',$language->name) }}" aria-labelledby="home-tab" role="tabpanel">
                                                                            <div class="col-12">
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-8">
                                                                                        <input type="text" id="first-name" class="form-control" name="{{ $language->locale }}[question]" value="{{ old($language->locale)["question"] }}" placeholder="عنوان السؤال">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-8">
                                                                                        <textarea name="{{ $language->locale }}[answer]" class="form-control" id="" placeholder="اجابة السؤال">{{ old($language->locale)["answer"] }}</textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
