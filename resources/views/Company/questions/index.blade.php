            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">جدول الاسئلة الشائعة</h2>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">
                                        <a href="{{ route('company.questions.create') }}" class="btn btn-success">اضف جديد</a>
                                            ...
                                            <tbody>
                                                @foreach($elements as $index=>$element)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('company.questions.destroy',$element->id) }}" method="post">
                                                                @method('delete')
                                                                {{ csrf_field() }}
                                                                <a href="{{ route('company.questions.edit',$element->id) }}" class="btn btn-success"><i class="fa fa-edit"></i> تعديل</a>
    ...
    <script>
        ...
        $('.delete_class').on('click',function (e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    window.location.href = `{{ route('company.questions.destroy') }}/${that.dataset.id}`;
                }
            })
        });
    </script>
