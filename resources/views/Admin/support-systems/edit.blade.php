                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form form-horizontal" action="{{ route('admin.support-systems.update',$element->id) }}" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            @method("put")
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                            <fieldset class="form-group">
                                                                ...
                                                                <div class="custom-file">
                                                                    <img src="{{ url('uploads/support_systems/'.$element->photo) }}" style="width: 60px;height: 60px;border-radius: 20px" alt="">
                                                                </div>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8 offset-md-4">
                                                        ...
                                                        <a href="{{ route('admin.support-systems.index') }}" class="btn btn-outline-warning mr-1 mb-1">عودة</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
