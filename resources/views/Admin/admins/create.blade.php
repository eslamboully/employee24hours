            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">اضف مشرف جديدة</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">اضف مشرف
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="{{ route('admin.admins.store') }}" method="post">
                                            {{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="first-name" class="form-control" name="name" placeholder="اسم المشرف">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="email-id" class="form-control" name="email" placeholder="البريد الالكتروني الخاص بالمشرف">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                                    ...
                                                                    @foreach ($crud as $ssd)
                                                                            <td>
                                                                                <div class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" id="{{ $ssd . '_' . $model }}" name="permissions[]" value="{{ $ssd . '_' . $model }}" class="custom-control-input">
