            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">جدول المشرفين</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">الرئيسية</a>
                                    </li>
                                    <li class="breadcrumb-item active">ادارة المشرفين
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">
                                            <a href="{{ route('admin.admins.create') }}" class="btn btn-success">اضف جديد</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('admin.admins.destroy',$element->id) }}" method="post">
                                                                @method('delete')
                                                                {{ csrf_field() }}
                                                                @if(im('admin')->hasPermissionTo('update_admins'))
                                                                <a href="{{ route('admin.admins.edit',$element->id) }}" class="btn btn-success"><i class="fa fa-edit"></i> تعديل</a>
                                                                @else
...
@push('js')
    ...
    <script>
        $('.company-block-button').on('click',function (e) {
            ...
            $.ajax({
                url: `{{ route('admin.admins.block') }}/${that.dataset.id}`,
                method: 'post',
        ...
        $('.delete_class').on('click',function (e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    window.location.href = `{{ route('admin.admins.destroy') }}/${that.dataset.id}`;
                }
            })
        });
    </script>
