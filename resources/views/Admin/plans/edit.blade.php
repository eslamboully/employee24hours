                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form form-horizontal" action="{{ route('admin.plans.update',$element->id) }}" method="post">
                                            {{ csrf_field() }}
                                            @method("put")
                                            <div class="form-body">
                                                <div class="row">
                                                                            ...
                                                                            <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ str_replace(' ','-',$language->name) }}" aria-labelledby="home-tab" role="tabpanel">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    <div class="form-group row">
                                                                                        ...
                                                                                        <div class="col-md-8">
                                                                                            <input type="text" id="first-name" class="form-control" name="{{ $language->locale }}[salary_type]" value="{{ $element->translate($language->locale)->salary_type }}" placeholder="خيارات الراتب">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="number" id="first-name" class="form-control" name="price" value="{{ $element->price }}" placeholder="سعر الباقة بالدولار">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="number" id="first-name" class="form-control" name="number_of_jobs" value="{{ $element->number_of_jobs }}" placeholder="عدد الوظائف">
                                                            </div>
                                                        </div>
                                                    </div>
