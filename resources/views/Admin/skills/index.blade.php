            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">جدول المهارات</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">الرئيسية</a>
                                    </li>
                                    <li class="breadcrumb-item active">ادارة المهارات
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">
                                        <a href="{{ route('admin.skills.create') }}" class="btn btn-success">اضف جديد</a>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.skills.destroy',$element->id) }}" method="post">
                                                        @method('delete')
                                                        {{ csrf_field() }}
                                                        <a href="{{ route('admin.skills.edit',$element->id) }}" class="btn btn-success"><i class="fa fa-edit"></i> تعديل</a>
    ...
    <script>
        $('.delete_class').on('click',function (e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    window.location.href = `{{ route('admin.skills.destroy') }}/${that.dataset.id}`;
                }
            })
        });
    </script>
