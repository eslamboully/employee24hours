                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            @foreach($languages as $index=>$language)
                                <a class="dropdown-item" href="{{ route('admin.change.lang',$index) }}" data-language="{{ $index }}">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            ...
                            <span class="badge badge-pill badge-primary badge-up">{{ count(im('admin')->notifications) }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            @foreach(im('admin')->notifications as $notification)
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ auth('admin')->user()->name }}</span><span class="user-status">Available</span></div><span><img class="round" src="{{ url('assets/Admin') }}/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span>
                        </a>
    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('assets/Admin') }}/html/rtl/vertical-menu-template/index.html">
                    ...
                    <h2 class="brand-text mb-0">@lang('admin.admin_panel')</h2>
                </a></li>
